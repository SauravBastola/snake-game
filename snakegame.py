...
class Main:
	...
	def draw_score(self):
		...
		score_x = int(cell_size * cell_number_x//2)
		score_y = int(cell_size * (cell_number_y+1) - 20)
...
cell_number_x=32
cell_number_y=18
window_size=(cell_size*cell_number_x,cell_size*(cell_number_y+1))

screen=pygame.display.set_mode(window_size)
clock=pygame.time.Clock()
apple=pygame.image.load("graphics/apple.png").convert_alpha()
game_font = pygame.font.Font("font/PoetsenOne-Regular.ttf",35)
